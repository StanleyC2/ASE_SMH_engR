...
public class ListingService {
    ...
    public Listing createListing(String agentEmail, ListingRequest request) {
        final User agent = userRepository.findByEmail(agentEmail)
    ...
    public Listing updateListing(Long listingId, String agentEmail, ListingRequest request) {
        ...
        if (request.getHasLift() != null) {
            listing.setHasLift(request.getHasLift());
        }
        if (request.getHasHeat() != null) {
            listing.setHasHeat(request.getHasHeat());
        }
