...
public class Recommender {
    ...
    private double cosineSimilarity(Response response1, Response response2) {
        ...
        final List<Integer> response1Values = response1.getResponseValues();
        final List<Integer> response2Values = response2.getResponseValues();
    ...
    public List<Long> getRecommendation(Response userResponse,
        ...
        final Queue<ScoredUser> queue = new PriorityQueue<>(
        ...
        for (Response response : allResponses) {
            ...
            final double similarity = cosineSimilarity(userResponse, response);
